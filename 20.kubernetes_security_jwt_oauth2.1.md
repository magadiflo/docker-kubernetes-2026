...
> enlaces lb://) y las clases `RestClientConfig.java` (removiendo `@LoadBalanced`). Para ser exactos todos estos
> archivos hasta este momento del curso fueron los modificados:
>
