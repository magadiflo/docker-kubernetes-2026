...
Al inspeccionar la consola del navegador en `http://localhost:8090` tras completar el login, observamos la presencia de
dos cookies distintas asociadas al dominio:
