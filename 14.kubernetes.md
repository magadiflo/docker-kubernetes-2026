...
|---------|-----------------------------|--------------------------------------------------------------------------------|
| Primera | `http://192.168.49.2:31169` | IP interna del nodo `Minikube + NodePort`. No siempre accesible desde el host. |
| Segunda | `http://127.0.0.1:52444`    | URL del túnel local. **Esta es la que usaremos** desde nuestra máquina.        |
